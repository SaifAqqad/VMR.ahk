...
class VMRStrip extends VMRDevice {
     ...
     */
    static GetDevice(p_name, p_driver?) => VMRDevice._GetDevice(VMRStrip.DEVICES, p_name, p_driver)
    ...
    /**
     * #### Set/Get the strip's upper gain limit. setting the gain above the limit will reset it to this value.
     */
    GainLimit {
        get {
